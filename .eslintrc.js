...
module.exports = {
    ...
    rules: {
        ...
        // 空格2个 参考：https://blog.csdn.net/u011350541/article/details/81049761
        'indent': 'off', //['error', 0, {'SwitchCase': 1}],
        ...
        'no-labels': 2, //禁止使用空label,Rule 'no-empty-label' was removed and replaced by: no-labels
        ...
        //'space-return-throw-case': 2, //return throw case后面要不要加空格,Rule 'space-return-throw-case' was removed and replaced by: keyword-spacing
